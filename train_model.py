...
class Model(object):
    ...
    FILE_PATH = "images\model.h5"   #模型进行存储和读取的地方
    ...
    def train_model(self):     #进行模型训练的函数，具体的optimizer、loss可以进行不同选择
        self.model.compile(
        ...
        self.model.fit(self.dataset.X_train,self.dataset.Y_train,epochs=10,batch_size=100)
